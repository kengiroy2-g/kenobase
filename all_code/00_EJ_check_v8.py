...
def vorpruefung_gegen_archiv_parallel(kombinationen_df, archiv_pfad, ergebnis_datei_pfad, checkpoint_pfad, batch_size=1000):
    global global_checkpoint_pfad
    global global_aktueller_fortschritt
...
def check_keno_numbers_parallel(csv_path, kombinationen_df, start_date, end_date, checkpoint_pfad, batch_size=1000):  ##################
    global global_checkpoint_pfad
    global global_aktueller_fortschritt
    global_checkpoint_pfad = checkpoint_pfad
