#!/usr/bin/env python
"""
Lotto 6aus49 Gewinnquoten Scraper - für 2025
...
def scrape_lotto_data(driver, date_text, max_retries=3):
    ...
    while retries < max_retries:
        try:
            ...
            # Suche nach allen Quoten-Tabellen (Lotto, Spiel77, Super6, Plus5)
            tables = soup.find_all('table', class_='table-quoten')

            game_names = ['Lotto 6aus49', 'Spiel 77', 'Super 6', 'Plus5']

            for idx, table in enumerate(tables):
                game_name = game_names[idx] if idx < len(game_names) else f'Spiel {idx+1}'
                ...
                for row in rows:
                    ...
                    if len(cells) >= 3:
                        ...
                        # Parse Gewinnklasse (z.B. "Gewinnklasse1(6 Richtige + Superzahl)")
    ...
    try:
        ...
        for idx, (value, date_text) in enumerate(dates, 1):
            try:
                ...
                # Daten scrapen
                result = scrape_lotto_data(driver, date_text)
...
if __name__ == "__main__":
    ...
    output_path = base_path / "Keno_GPTs" / "Lotto6aus49_GQ_2025.csv"

    print("=" * 60)
    print("Lotto 6aus49 Gewinnquoten Scraper - Jahr 2025")
    print("=" * 60)
