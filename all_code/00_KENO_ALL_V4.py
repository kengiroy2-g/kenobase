...
file_config = {
    ...
    "filtered_data_path": "C:\\Users\\Admin1\\Documents\\01_PROJECT\\Keno_GPTs\\10-9-8_KGDaten_gefiltert.csv", # "1-2-3" represente les kenotyp utiliser lors du filtrage ayant lieu ds la funktion filter_and_sort_keno_data
    # Contient les resultat du filtrage de  tous les Tirage d'une Periode Precise qui ont une apparition d'un GK1
    
    "numbertocheck_path": "C:\\Users\\Admin1\\Documents\\01_PROJECT\\Keno_GPTs\\10-9-8_NumbertoCheck.csv",# enthält alle Ziehungen wo ein vordefinierte gewinnklasse (zb GK1 kenoty10) eingetroffen ist
    "checknumbers_path": "C:\\Users\\Admin1\\Documents\\01_PROJECT\\Keno_GPTs\\10-9-8_CheckNumbers.csv",#Datum,Date_Check,Anzahl Treffer,Treffer-Zahlen | verifie les Treffer dun tirage mit GK1 ds tous les autre tirage GK1
    "checknumbers_pathz120": "C:\\Users\\Admin1\\Documents\\01_PROJECT\\Keno_GPTs\\10-9-8_CheckNumbers_z120.csv",
    "liste_gk1_treffer_path": "C:\\Users\\Admin1\\Documents\\01_PROJECT\\Keno_GPTs\\10-9-8_Liste_GK1_Treffer.csv"# Contient la füsion de KGDaten_gefiltert & CheckNumbers 
...
# detailed_results_df = check_keno_numbers_extended(csv_path)
...
detailed_results_df = check_keno_numbers(file_config['numbertocheck_path'])
